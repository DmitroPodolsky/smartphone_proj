...
class Phones_comments_Seria1(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.save()
        check = Phone_comments.objects.filter(phone_id=instance.phone_id).aggregate(total1=Sum('rate'),total2=Count('rate'))
...
class AirPods_comments_Seria(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        user.save()
        check = AirPods_comments.objects.filter(airpod_id=restorans_id).aggregate(total1=Sum('rate'), total2=Count('rate'))
...
class AirPods_comments_Seria1(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.rate = new_rate
        instance.save()
        check = AirPods_comments.objects.filter(airpod_id=instance.airpod_id).aggregate(total1=Sum('rate'),total2=Count('rate'))
